...
<img src="./Images/SIRPNPRO.png" alt="\label{fig:SIR_PN} Petri Net representation of the SIR model." width="1325" />
<p class="caption">
...
<img src="./Images/prcc_SIR-sensitivity.png" alt="\label{fig:prcc} PRCC for the I place over time." width="1400" />
<p class="caption">
...
<img src="./Images/Sim_Iplace.png" alt="\label{fig:I_traces_cal} Trajectories considering the I place." width="576" />
<p class="caption">
 Trajectories considering the I place.
</p>

<img src="./Images/Sim_Splace.png" alt="\label{fig:S_traces_cal}Trajectories considering the S place." width="576" />
<p class="caption">
Trajectories considering the S place.
</p>

<img src="./Images/Sim_Rplace.png" alt="\label{fig:R_traces_cal} Trajectories considering the R place." width="576" />
<p class="caption">
