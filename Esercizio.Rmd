...
AnalysisPlot = ModelAnalysisPlot(Ref = T,Stoch = T,print=F)
AnalysisPlot$plS
AnalysisPlot$plI
```
...
an example is given by *msqd.R* where a distance measure (based on the squared error distance) as function of the infected individuals is defined:
```{r, linewidth = 80 }
...
plots <- calibration.plot(folder = "Results/results_model_calibration/",solver_name="SIR",print=F)
plots$plS
plots$plI
plots$plR
