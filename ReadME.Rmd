...
Notice that *model_generation()* might take as input parameter a C++ file defining the functions characterizing the behavior of general transitions [@Pernice19], namely *functions_fname*. 
...
row.names(a) <- c("Time","S","I","R")
colnames(a) <- paste0("TimeStep",1:701)
a[,1:7]
```
...
knitr::include_graphics("./Images/Sim_Iplace.png")
knitr::include_graphics("./Images/Sim_Splace.png")
knitr::include_graphics("./Images/Sim_Rplace.png")
