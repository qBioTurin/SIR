...
model_analysis("./Net/SIR.solver",f_time=100,s_time=1)
...
ModelAnalysisPlot("results_model_analysis/SIR-analysis-1.trace")


#Execute model_analysis to derive the model behaviors using SSA
model_analysis("./Net/SIR.solver",solver_type = "SSA",f_time=100,s_time=1,n_run = 500)
#Execute the function ModelAnalysisPlot
ModelAnalysisPlot("./results_model_analysis/SIR-analysis-1.trace",Stoch = TRUE)


#Execute model_analysis to derive the model behaviours updating  parameters
model_analysis("./Net/SIR.solver",f_time=100,s_time=1,
...
#Execute model_analyisis to derive the model behaviors using SSA
model_analysis(solver_fname = "./Net/SIR.solver",solver_type = "SSA",f_time=100,s_time=1,n_run =500,parameters_fname = "./Input/Functions_list_ModelAnalysis.csv")
#Execute the function ModelAnalysisPlot
ModelAnalysisPlot("./results_model_analysis/SIR-analysis.RData",Stoch = TRUE)


#Execute model_calibration to derive those paramter values fitting an input data. Observe that the data are generated by the model with 0.04 and 0.0004
...
#Execute the function ModelAnalysisPlot
calibration.plot("results_model_calibration/SIR","./Input/reference_data.csv")
